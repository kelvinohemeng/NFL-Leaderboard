  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <img
            className="max-w-[600px] absolute -left-[10vh] -bottom-[10vh]"
            src="/qbtoss.png"
            alt=""
          />
          <div className=" w-full md:w-[50vw] h-[85vh] bg-white bg-opacity-10 backdrop-blur-md flex flex-col space-y-10 p-3 md:p-5 rounded-lg">
            <div className="flex  flex-col">
              <div className=" w-full flex flex-col md:flex-row justify-between items-center space-y-2">
                <div className="flex justify-center md:justify-start w-full">
                  ...
                  <h1 className="bold text-5xl">QB TOSS</h1>
                </div>
                <img
            ...
            <div className="scroll  flex flex-col justify-start items-start overflow-y-scroll h-full ">
              <div className=" flex justify-between w-full p-3 text-xl text-white  font-bold sticky top-0 bg-[#191818]">
                <div className=" flex gap-2 md:gap-4 text-xl font-medium">
                  <h1>Pos.</h1>
                  <h1>Name</h1>
                </div>
                <h1>Score</h1>
